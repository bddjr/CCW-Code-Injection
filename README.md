...
5. 在控制台里粘贴以下代码，然后enter执行
    ...
    ```
5. 访问 https://www.ccw.site/profile/personal ，然后修改你的昵称和个性签名，然后点击“保存”。
6. 使用 [QQ](https://im.qq.com/) 联系共创世界管理员（3026904139）申诉，说明你的账号被黑客入侵，并将账号id告诉他，并且说明你已修改密码。
