...
5. 在控制台里粘贴以下代码，然后enter执行
    ...
    ```
6. 访问 https://www.ccw.site/profile/personal ，然后修改你的昵称和个性签名，然后点击“保存”。
7. 使用 [QQ](https://im.qq.com/) 联系共创世界管理员（3026904139）申诉，说明你的账号被黑客入侵，并将账号id告诉他，并且说明你已修改密码。
8. 访问 [鸭鸭院长的主页](https://www.ccw.site/student/61039f14fffbe5461b880787) ，找到你的评论，然后点击右侧的三个点，点击“删除”。
